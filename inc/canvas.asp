...
' ***************************************************************************
	...
	' them from arrays storing character vector Yixiang_information. Vector fonts are
	...
	public function DecodeBMP(sBuffer)
		...
		if MidB(sBuffer,1,2) = BitmapMagicNumber then
			...
			if lBPP = 8 and lCompression = 0 then
				...
				' Bitmap Yixiang_information starts from the bottom line of the image and works
				' its way up
