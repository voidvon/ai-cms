...
Function Random(CatID)
	...
	RandomI=0
	Sql="Select top 4 * from benming_ch_prod where Catid="&CatID&" ORDER BY Rnd(id)"
	...
	Do while not Rs_Random.eof
		...
		strs=strs&"<img src="""&Rs_Random("smallpic")&"""alt="""&Rs_Random("prodName")&""" width=""95"" height=""70"" />"
		strs=strs&"</td>"
       	strs=strs&"</tr>"
        strs=strs&"<tr>"
