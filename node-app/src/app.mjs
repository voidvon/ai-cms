...
import { HOST, PORT, PROJECT_ROOT } from './config.mjs';
...
export async function createApp(options = {}) {
  ...
  await app.register(fastifyCookie, {
    secret: process.env.COOKIE_SECRET || 'spiraxsarcocn-node-app-secret-key-change-in-production',
    parseOptions: {}
  });
  ...
  await app.register(import('./routes/admin/index.mjs'), { prefix: '/admin' });
