...
<form name="form" method="POST" action="job_save.asp?action=Save"> 
      ...
      <TD> <TABLE width="100%" border="0" cellpadding="5" cellspacing="2" bordercolorlight="#CEE7FF" bordercolordark="#CEE7FF" style="border-collapse: collapse"> 
          <TR> 
            ...
            <TD colspan="3" class="Forumrow"><font color="#F4FAFF">
              <input name="jobName" type="text" id="jobName" value="<%=jobName%>">
            </a></font>  <span class="STYLE2">*</span>
            <input type="hidden" name="hidid" value="<%=id%>"></TD>
          </TR>
		  
		   <TR> 
            <TD align="right" valign="middle" class="Forumrow"><b>工作地区</b>：</td> 
            <TD colspan="3" class="Forumrow"><font color="#F4FAFF">
			  <input name="address" type="text" class="smallInput" id="address" value="<%=address%>" size="55" maxlength="50">
              <a href="prodcat_add.asp"><span class="STYLE2">*</span></a></font></TD> 
          </TR>
		      	  		  		  		 
		       <TR>
		         <td class="Forumrow" align="right"><b>招聘人数： </b></td>
		         <TD colspan="3" class="Forumrow"><input name="jobnob" type="text" id="jobnob" value="<%=jobnob%>" size="5">
		  ...
		  <TR>
		    ...
		    <TD width="209" valign="middle" class="Forumrow"><input name="linkren" type="text" id="linkren" value="<%=linkren%>" size="30">
	        <a href="prodcat_add.asp"><span class="STYLE2">*</span></a></TD>
	        <TD width="92" valign="middle" class="Forumrow"><B>联系电话：</B></TD>
	        <TD width="452" valign="middle" class="Forumrow"><input name="phone" type="text" id="phone" value="<%=phone%>">
            <a href="prodcat_add.asp"><span class="STYLE2">*</span></a></TD>
          </TR>
		   
          <TR>
            <TD align="right" class="Forumrow"><b>发布状态：</b></TD>
            <TD colspan="3" class="Forumrow"><input name="state" type="checkbox" id="state" value="1" <%if state1=1 then response.Write("checked")%> >
              (<span class="STYLE2">选中为发布状态</span>)</TD>
          </TR>
          <TR> 
            <TD align="right" class="Forumrow"><b>任职要求：</b></TD> 
            <TD colspan="3" class="Forumrow"><textarea name="content" style="display:none"><%=content%></textarea><iframe ID="eWebEditor1" src="/editor/ewebeditor.asp?id=content&style=standard&originalfilename=d_originalfilename &savefilename=d_savefilename &savepathfilename=d_savepathfilename" frameborder="0" scrolling="no" width="617" HEIGHT="450"></iframe></TD> 
          </TR> 
          <TR height="40"> 
