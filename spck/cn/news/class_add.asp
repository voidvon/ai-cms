...
<FORM name="FORM1" id="FORM1" onSubmit="return FORM1_onsubmit()" action="Class_Save.asp?action=add" method="post"> 
  <TABLE width=100% border="0" align="center" cellPadding=3 cellSpacing=1 class="tableBorder"> 
    ...
    <TR> 
      ...
      <TD width=59% height=25 class="forumRowHighlight"><INPUT name=CatName id="CatName" size=25 maxLength=40> <font color='#FF0000'>*</font></TD> 
    </TR> 
    <TR>
