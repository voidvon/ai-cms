...
if Chkrequest(id) then
	...
	if Rs.eof and rs.bof then
		call HOPE_err("错误","分类不存在","返回","Class.asp")
		Response.End
	else
		CatName=Rs("CatName")
		ORderID=Rs("ORderID")
...
<FORM name="FORM1" id="FORM1" onSubmit="return FORM1_onsubmit()" action="Class_Save.asp?action=Save" method="post"> 
  <TABLE width=100% border="0" align="center" cellPadding=3 cellSpacing=1 class="tableBorder"> 
    <TR> 
      <Th colSpan=2 height="28" class="tableHeaderText">添加新闻类别</Th> 
    </TR> 
    <TR>
    ...
    <TR> 
      ...
      <TD width=59% height=25 class="forumRowHighlight"><INPUT name=CatName id="CatName" value="<%=CatName%>" size=25 maxLength=40> <font color='#FF0000'>*</font></TD> 
    </TR> 
    <TR>
