...
<form name="form" method="POST" action="News_save.asp?action=save"> 
<input type='hidden' name="picture" value = "">
<input type='hidden' name="hidid" value = "<%=newsid%>">
      ...
      <TD> <TABLE width="100%" border="0" cellpadding="5" cellspacing="2" bordercolorlight="#CEE7FF" bordercolordark="#CEE7FF" style="border-collapse: collapse"> 
          <TR> 
            ...
            <TD colspan="2" class="Forumrow"><font color="#F4FAFF"> 
              ...
              <input name="title" type="text" class="smallInput" value="<%=title%>" size="55" maxlength="100"> 
...
if picture<>""  or picture<>"/UploadFile/nopicture.gif" then
  %>
<img src="<%=picture%>"  width="35" height="35">
<%
else
%>
暂无图片!
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id=adv style="DISPLAY: none">
  <tr>
    <td width="92%">
<!----------------------------------------------------文件上传----------------------------------------------->
  <iframe id="d_file" frameborder="0" src="/inc/upload.asp?tMode=2&istwo=0&utype=news" width="300" height="40" scrolling="no"></iframe>
  <!---------------------------------------------------------------------------> 
	  <input type="hidden" name="oldpic" value="<%=picture%>" maxlength="40"> 
	  </td>
  </tr>
  <tr>
  	<td><input type="radio" name="cimg" value="1" checked><b><font color="red">▲</font></b>使用原有图片 
         <input type="radio" name="cimg" value="2"><b><font color="red">◆</font></b>删除原有图片重新上传
	</td>
  </tr>
...
<span style="color:red;">添加到图文列表</span>--></TD>
		  ...
		  <TR>
		    ...
		    <TD colspan="2" valign="middle" class="Forumrow"><input name="key" type="text" id="key" value="<%=key%>" size="100"></TD>
	      </TR>
		  <TR> 
            <TD align="right" class="Forumrow"><b>简单描述：</b></td> 
            <TD colspan="2" valign="middle" class="Forumrow"><textarea name="desc" cols="100" rows="5" id="desc"><%=desc%></textarea></TD> 
          </TR> 
          <TR> 
            <TD align="right" class="Forumrow"><b>详细信息：</b></TD> 
            <TD colspan="2" class="Forumrow">
			
			 <textarea name="content" id="myEditor" style="width:720px; height:300px"><%=content%></textarea>
