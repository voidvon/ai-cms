...
if Rs.eof =false and Rs.bof=false then
	...
	magicfacepic1=Rs("smallpic")
	magicfacepic2=Rs("bigpic")
	tjhome=Rs("tjhome")
	orderid=Rs("orderid")
	key=Rs("key")
	desc=Rs("remark")
...
<form name="form" method="POST" action="prod_save.asp?action=save"> 
  ...
  <TABLE width="100%" border="0" align=center cellpadding="0" cellspacing="1" class="tableBorder"> 
    ...
    <TR ALIGN="center"> 
      <TD> <TABLE width="100%" border="0" cellpadding="5" cellspacing="2" bordercolorlight="#CEE7FF" bordercolordark="#CEE7FF" style="border-collapse: collapse"> 
          <TR> 
            <TD width="110" align="right" nowrap class="Forumrow"><b>产品<b>分类</b>：</b></TD> 
            <TD colspan="4" class="Forumrow"><font color="#F4FAFF">
			  ...
			  Rs.open Sql,Conn,1,1
			  do while not Rs.eof
			  	if cint(typeid)=Cint(Rs("id")) then
			  		Response.Write "<option  value="&Rs("id")&" selected>==="&Rs("CatName")&"===</option>"
				else 
				...
				do while not Rs1.eof
					if cint(typeid)=Cint(Rs1("id")) then
						Response.Write "<option value="&Rs1("id")&" selected>&nbsp;&nbsp;"&Rs1("CatName")&"</option>"
					else
              ...
              <a href="prodcat_add.asp"><font color='#FF0000'>添加
		   ...
		   <TR> 
            ...
            <TD colspan="4" class="Forumrow"><font color="#F4FAFF">
			  <input name="prodName" type="text" class="smallInput" id="prodName" value="<%=prodName%>" size="55" maxlength="100">
			  <font color='#FF0000'>*</font>			  </font></TD> 
          </TR>
		       <script language = "JavaScript" src = "../../../js/file_js.js" type="text/javascript"></script>  		  		  		  		 
		       <TR>
		         <td class="Forumrow" align="right"><b>产品型号： </b></td>
		         <TD colspan="4" class="Forumrow"><input name="prodCode" type="text" id="prodCode" value="<%=prodCode%>"></TD>
          </TR>
	       <TR>
		     <td class="Forumrow" align="right"><b>产品小图：</b></td>
		     <TD colspan="4" class="Forumrow">
			 	<input name="magicfacepic1" type="text" ID="magicfacepic(1)" onClick="lookmagic(1)" value="<%=magicfacepic1%>" size="40" readonly><iframe id="d_file" frameborder="0" src="../../../inc/upload2.asp?tMode=3&istwo=0&utype=prod&hgc=1" width="450" height="22" scrolling="no"></iframe></TD>
	       </TR>
	      <TR >
		  	</TR>
          <TR> 
            <TD align="right" class="Forumrow"><b>产品属性： </b></TD> 
            <TD width="98" class="Forumrow">
		
              <input name="tjhome" type="checkbox" id="tjhome" value="1" <%if tjhome=1 then response.Write "checked"%>> 
            首页推荐     		</TD> 
            <TD width="104" class="Forumrow"><input name="show" type="checkbox" id="show" value="0"  <%if show=0 then response.write "checked"%>>
            隐藏</TD>
            <TD width="46" class="Forumrow" ><b>排序：</b>			</TD>
            <TD width="516" class="Forumrow"  ><input name="orderid" type="text" id="orderid" value="<%=orderid%>" size="5"></TD>
          </TR>

		  <TR>
		    <TD align="right" class="Forumrow"><b>关键字：</B></td>
		    <TD colspan="4" valign="middle" class="Forumrow"><input name="key" type="text" id="key" value="<%=key%>" size="100"></TD>
	      </TR>
		  <TR> 
            <TD align="right" class="Forumrow"><b>产品描述：</b></td> 
            <TD colspan="4" valign="middle" class="Forumrow"><textarea name="desc" cols="100" rows="5" id="desc"><%=desc%></textarea></TD> 
          </TR> 
          <TR> 
            <TD align="right" class="Forumrow"><b>详细信息：</b></TD> 
            <TD colspan="4" class="Forumrow">
            
            <textarea name="content" id="myEditor" style="width:720px; height:350px"><%=content%></textarea>
