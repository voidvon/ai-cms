...
if Chkrequest(id) then
	...
	if Rs.eof and rs.bof then
		call HOPE_err("错误","分类不存在","返回","prodcat.asp")
		Response.End
	else
		CatName=Rs("CatName")
		ORderID=Rs("ORderID")
...
<FORM name="FORM1" id="FORM1" onSubmit="return FORM1_onsubmit()" action="prodcat_save.asp?action=Save" method="post"> 
  <TABLE width=100% border="0" align="center" cellPadding=3 cellSpacing=1 class="tableBorder"> 
    ...
    <TR> 
      ...
      <TD width=69% height=25 class="forumRowHighlight"><INPUT name=CatName id="CatName" value="<%=CatName%>" size=25 maxLength=40> <font color='#FF0000'>*</font></TD> 
    </TR> 
    <TR>
    ...
    <TR>
      ...
      <TD height="27"  class="forumRowHighlight"><input name="key" type="text" id="key" value="<%=key%>" size="80"></TD>
    </TR>
    <TR>
      <TD height="27"  class="forumRowHighlight" align="right"><b>分类描述：</b></TD>
      <TD height="27"  class="forumRowHighlight"><textarea name="desc" cols="80" rows="5" id="desc"><%=desc%></textarea></TD>
    </TR>
    <TR> 
      <TD colSpan=2 height="27" align=center class="forumRowHighlight"> <INPUT type=submit value='确 定 修 改' name=Submit2> </TD> 
    </TR> 
  </TABLE> 
