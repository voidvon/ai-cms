...
if request.QueryString("action")="add" then
	Sql="Select * from benming_ch_ProdCat"
...
添加新闻分类成功！<br>
<br>
<a href="prodcat_add.asp">继续添加
</a></div></td></tr><tr align=center><td height=30 class=forumRowHighlight><a href='prodcat.asp'>&lt;&lt; 返回</a></td></tr></table><br>
...
<body>
<table cellpadding=2 cellspacing=1 border=0 width=400 class=tableBorder align=center><TR>
  <TH class=tableHeaderText colSpan=2 height=25>修改产品分类</TH>
<TR><tr><td height=85 valign=top class=forumRow><div align=center><br><br>
修改产品分类成功！<br>
<br>
</div></td></tr><tr align=center><td height=30 class=forumRowHighlight><a href='prodcat.asp'>&lt;&lt; 返回</a></td></tr></table><br>
...
<table cellpadding=2 cellspacing=1 border=0 width=400 class=tableBorder align=center>
	<TR>
  		<TH class=tableHeaderText colSpan=2 height=25>删除产品分类</TH>
	<TR>
	<tr>
