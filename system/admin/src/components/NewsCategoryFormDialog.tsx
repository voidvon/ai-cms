...
export default function NewsCategoryFormDialog({
  ...
  }, [category, categoryDetailData?.data, currentParentId, mode, defaultLanguageCode, availableLanguageCodes.join('|'), bindingsData?.data])
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="rounded border p-4 space-y-4">
            ...
            <div className="space-y-2">
              <Label>内容页命名规则</Label>
              <Select
                value={baseData.detail_rule || 'detail/{id}.html'}
